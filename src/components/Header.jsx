  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-20 w-full px-[16px] py-[24px] bg-base-300 dark:bg-base-100/60 dark:backdrop-blur-3xl">
      <div className="flex items-center justify-between">
        ...
        {/* Money */}
        <div className="flex justify-between w-[95px] p-2.5 bg-base-200 border-2 border-base-content rounded-full dark:border-base-content dark:border-2">
          <p>500</p>
          <span>🪙</span>
        </div>
        ...
        <details className="dropdown dropdown-end">
          <summary className="btn w-[45px] h-[40px] p-0 bg-transparent border-base-content rounded-full border-2 shadow-none">
