      ...
      <div className="flex items-center justify-between">
        ...
        <div className="dropdown">
          <div
            tabindex="0"
            role="button"
            className="btn p-0 w-[35px] h-[35px] bg-transparent border-none shadow-none"
          >
            <svg
          ...
          <ul
            tabindex="0"
            className="z-[9000] w-[100px] p-[10px] bg-base-100  rounded-box dropdown-content"
          >
            <li className="py-[5px]">English</li>
            <li className="py-[5px]">German</li>
          </ul>
        </div>
        ...
        <div className="flex justify-between w-[95px] p-[15px] bg-base-200 border-2 border-base-300 rounded-full">
          <p>500</p>
          <img className="h-[23px]" src="images/coin.png" alt="Coins"></img>
        </div>
        ...
        <div className="dropdown dropdown-end">
          <div
            tabindex="0"
            className="btn w-[45px] h-[40px] p-0 bg-transparent border-white shadow-none"
          >
            <img
              src="images/dummyPB.webp"
          ...
          <ul
            tabindex="0"
            className="flex flex-col justify-between menu dropdown-content w-[122px] p-[10px] z-50 bg-base-100 rounded-box"
          >
            <li className="py-[5px]">Edit Profile</li>
            <li className="py-[5px]">Home</li>
            <li className="py-[5px]">Logout</li>
          </ul>
        </div>
      </div>
      {searchBar && (
