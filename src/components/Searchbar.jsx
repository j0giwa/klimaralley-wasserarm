...
function Searchbar ({ categories }) {
  ...
  return (
    <>
      ...
      <label class="input input-bordered flex items-center bg-base-200 border-base-300 gap-2 dark:border-base-content dark:border-2 light:">
        ...
        <button >
          <svg xmlns="http://www.w3.org/2000/svg"
            className="h-4 w-4 fill-white opacity-70"
            viewBox="0 0 16 16">
