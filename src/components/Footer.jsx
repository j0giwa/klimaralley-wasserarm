...
function Footer({ cartItems, onAdd, onRemove }) {
  ...
  return (
    <>
      <div className="flex justify-between items-center fixed bottom-0 left-1/2 transform -translate-x-1/2 z-10 w-[374px] h-[60px] mx-[30px] my-[4px] bg-base-100 rounded-full border-base-100 ">
        <div>1</div>
        <div>2</div>
